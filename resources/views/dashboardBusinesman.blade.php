                        ...
                        <table class="table-auto w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-gray-200">
                                    <th class="border px-4 py-2 w-32 text-center">Judul</th>
                                    <th class="border px-4 py-2 w-2 text-center">Jumlah</th>
                                    <th class="border px-4 py-2 w-48 text-center">Requirement</th>
                                    <th class="border px-4 py-2 w-48 text-center">Benefit</th>
                                    <th class="border px-4 py-2 w-48 text-center">Lokasi</th>
                                    <th class="border px-4 py-2 w-32 text-center">Tag</th>
                            ...
                            <tbody>
                                @foreach ($tableLowongan as $lowongan)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="border px-4 py-2">
                                            {{ $lowongan->provinsi }}, {{ $lowongan->kecamatan }},
                                            {{ $lowongan->kelurahan }}
                                        </td>
                                        <td class="border px-4 py-2">
                    ...
                    <form x-bind:action="`/dashboardBusinesman/${selectedLowongan.id}`" method="POST"
                        ...
                        <div class="md:flex md:row md:space-x-4 w-full text-xs">
                            <div class="w-full flex flex-col mb-3">
                                ...
                                <select
                                    class="block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                    name="provinsi" id="Editprovinsi" x-model="selectedLowongan.provinsi" required>
                                    <option value="">Pilih</option>
                                </select>
                            </div>
                            <div class="w-full flex flex-col mb-3">
