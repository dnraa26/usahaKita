                ...
                <nav>
                    <ul>
                        <a href="/dashboardBusinesman" class="text-gray-600">
                            <li class="p-3 {{ request()->is('dashboardBusinesman') ? 'bg-gray-200' : 'text-gray-600' }} hover:bg-gray-200">
                                Tambah Lowongan Bisnis
                            </li>
                        </a>
                        <a href="/manageProfilPerusahaanBusinesman" class="text-gray-600">
                            <li class="p-3 {{ request()->is('manageProfilPerusahaanBusinesman') ? 'bg-gray-200' : 'text-gray-600' }} hover:bg-gray-200">
                ...
                <div class="bg-white shadow-xl rounded-lg p-5">
                    ...
                    <form action="/saveProfile" method="POST" class="space-y-4">
                        ...
                        <div class="flex flex-col items-center mb-4">
                            <label class="text-md font-semibold text-gray-700 mb-1">Foto Profil</label>
                            <div class="relative">
                        ...
                        <div x-data="{ activeSection: 'personalInfo' }" class="space-y-2">
                            ...
                            <div class="bg-blue-50 p-4 rounded-lg shadow-inner" x-show="activeSection === 'personalInfo'">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" class="w-full p-2 border rounded-lg" name="name" value="Zee Asadel">
                                    </div>
                                    <div>
                                        <label class="block text-gray-600 font-semibold mb-1">Email</label>
                                        <input type="email" class="w-full p-2 border rounded-lg" name="email" value="zeeasadel@example.com">
                                    </div>
                                    <div>
                                        <label class="block text-gray-600 font-semibold mb-1">Telepon</label>
                                        <input type="tel" class="w-full p-2 border rounded-lg" name="phone" value="+62 812 3456 7890">
                                    </div>
                                </div>
                            </div>

                            <!-- Address Section in Tab/Accordion -->
                            <div class="bg-blue-50 p-4 rounded-lg shadow-inner" x-show="activeSection === 'address'">
                                <h3 class="text-xl font-semibold text-gray-700 mb-2">
                                    <i class="fas fa-map-marker-alt mr-2"></i>Alamat
                                </h3>
                                <div>
                                    <label class="block text-gray-600 font-semibold mb-1">Alamat</label>
                                    <input type="text" class="w-full p-2 border rounded-lg" name="address" value="Jalan Darjo">
                                </div>
                            </div>

                            <!-- Company Description -->
                            <div class="bg-blue-50 p-4 rounded-lg shadow-inner" x-show="activeSection === 'description'">
                                <h3 class="text-xl font-semibold text-gray-700 mb-2">
                                    <i class="fas fa-building mr-2"></i>Deskripsi Perusahaan
                                </h3>
                                <textarea class="w-full p-2 border rounded-lg" name="description" rows="3">Kami adalah perusahaan yang bergerak di bidang pengembangan bakat...</textarea>
                            </div>

                            <!-- Job Openings Section -->
                            <div class="bg-blue-50 p-4 rounded-lg shadow-inner" x-show="activeSection === 'jobOpenings'">
                                <h3 class="text-xl font-semibold text-gray-700 mb-2">
                                ...
                                <div class="space-y-2">
                                    <div class="bg-white p-3 rounded-lg shadow-sm flex justify-between items-center">
                                        <div>
                                            ...
                                            <p class="text-gray-600 text-sm">⭐ 4.2 • 430 Ulasan</p>
                                        </div>
