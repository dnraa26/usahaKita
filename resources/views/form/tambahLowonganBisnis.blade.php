        ...
        <div
            ...
            <div class="max-w-4xl w-full space-y-8 p-10 bg-white rounded-lg shadow-2xl z-10">
                <div class="grid gap-6">
                    ...
                    <form action="{{ route('perusahaan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf

                        <div class="space-y-1">
                            <label class="font-semibold text-gray-700">Nama Lowongan Bisnis <abbr title="required">*</abbr></label>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="cabang_pusat"
                                   placeholder="Alamat"
                                   class="block w-full border border-gray-300 rounded-lg h-10 px-4 text-gray-700 focus:border-blue-500 focus:ring focus:ring-blue-200 transition"
                                   value="{{ old('alamat') }}">
                        </div>
                        ...
                        <div class="space-y-1">
                            <label class="font-semibold text-gray-700">Kualifikasi <abbr title="required">*</abbr></label>
                        ...
                        <div class="space-y-1">
                            ...
                            <textarea name="keuntungan"
                                      placeholder="Masukkan keuntungan perusahaan"
                        ...
                        <p class="text-xs text-gray-500 text-right my-3">Bidang yang wajib diisi ditandai dengan tanda bintang <abbr title="Required field">*</abbr></p>
