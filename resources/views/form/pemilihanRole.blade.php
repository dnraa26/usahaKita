            ...
            <div class="bg-gray-100 shadow-2xl rounded-lg w-8/12 shadow-2xl p-8 md:w-3/2">
                ...
                <form action="{{ route('pickRole') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <!-- Businessman box -->
                        <div class="relative bg-white rounded-xl shadow-md p-6 hover:bg-blue-400 transition duration-300" id="businessmanBox">
                        ...
                        <div class="relative bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition duration-300" id="businessPartnerBox">
